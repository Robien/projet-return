...
int main()
{
	...
	try
	{
		...
		// The basic plugins you are the most likely to use are the RenderSystems, the particle FX and the Cgprogram.
		{
			...
			lPluginNames.push_back("/usr/local/lib/OGRE/Plugin_ParticleFX");
			//lPluginNames.push_back("/usr/local/lib/OGRE/Plugin_CgProgramManager");
			//lPluginNames.push_back("Plugin_PCZSceneManager");
			//lPluginNames.push_back("Plugin_OctreeZone");
			lPluginNames.push_back("/usr/local/lib/OGRE/Plugin_OctreeSceneManager");
